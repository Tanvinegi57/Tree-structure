...
export class AppComponent {
  ...
  onAction: string = '';
  openAddTextField(id: number, action: string, title: string) {
    this.rootID = id;
  ...
  openAddTextFieldForLevel2(id: number, action: string, title: string) {
    this.Level3Id = id;
    this.onAction = action;
    if (action === 'Save') {
      this.form.controls['title'].setValue('');
